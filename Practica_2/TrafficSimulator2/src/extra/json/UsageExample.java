...
public class UsageExample {
	...
	public static void main(String[] args) throws JSONException, FileNotFoundException {
		...
		createExample();*/
                ...
                JSONObject joFromFile2 = new JSONObject(
				new JSONTokener(new FileInputStream(new File("resources/salidas/ex2.out.json"))));
                System.out
				.println("Are joFromFile1 and joFromFile2 euqal? " + checkSemanticEquality(joFromFile1, joFromFile2));
