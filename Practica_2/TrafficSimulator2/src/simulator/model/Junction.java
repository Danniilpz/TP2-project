...
public class Junction extends SimulatedObject{
    ...
    public String getGreenLightRoad(){
        if(this.currentGreen==-1) return "NONE";
        else return this.carreteras_entrantes.get(currentGreen).getId();
    }
    ...
    public List<List<Vehicle>> getColas() {
        return colas;
    }
    ...
    public String getMapaColasString() {
        String s="";
        for(Road r:this.carreteras_entrantes){
            List<Vehicle> l=this.mapa_colas.get(r);
            s+=r.getId()+":"+l.toString()+" ";
        }
        return s;
    }
